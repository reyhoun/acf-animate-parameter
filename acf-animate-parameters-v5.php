...
class acf_field_animate_parameters extends acf_field {
	...
	*/
	...
	function __construct() {
		...
		*/
		...
		$this->label = __('Animate Parameters', 'acf-animate_parameters');
		...
		*/
		...
		$this->defaults = array(
			...
			'select_animate_type_1'	=> 'bounce',
			'select_animate_type_2'	=> 'bounce',
			'select_animate_type_3'	=> 'bounce',
		...
		*/
		...
		$this->l10n = array(
			'error'	=> __('Error! Please enter a higher value', 'acf-animate_parameters'),
		);
	...
	function render_field_settings( $field ) {
		...
		*/
		...
		acf_render_field_setting( $field, array(
			...
			'instructions'	=> __('Customise the input font size','acf-animate_parameters'),
			'type'			=> 'radio',
			'name'			=> 'enable_effect',
			'layout'  		=>  'horizontal',
			'choices' =>  array(
                1 => __('Yes', 'acf-animate_parameters'),
                0 => __('No', 'acf-animate_parameters'),
            )
		));
		...
		acf_render_field_setting( $field, array(
			'label'			=> __('Increase Delay','acf-animate_parameters'),
			'instructions'	=> __('','acf-animate_parameters'),
			'type'			=> 'number',
			'name'			=> 'increase_delay',
			'append'		=> 'ms',
	...
	*/
	...
	function render_field( $field ) {
        ...
        if( empty($field['value']) ){
            ...
            $field['value']['animate_delay_time'] 	= $field['animate_delay_time'];
            $field['value']['increase_delay']       = $field['increase_delay'];
        }
		...
		*/
		...
		for ($i=1; $i <= $field['select_animate_type'] ; $i++) { 
			...
			$e.= '<ul class="acf-hl">';
			$e.= '<li style="width:55%; padding-right:15px;"><div class="acf-input-prepend">' . __("Animate Start Delay Time", "acf-image-resize-parameter") . '</div><div class="acf-input-append">ms</div><div class="acf-input-wrap">';
			...
			$e.= '</div></li>';
			$e.= '<li style="float:none;"><div class="acf-input-prepend">' . __("Increase Delay", "acf-image-resize-parameter") . '</div><div class="acf-input-append">ms</div><div class="acf-input-wrap">';
	...
	*/
	...
	function validate_value( $valid, $value, $field, $input ){
		...
		if( $value < $field['custom_minimum_setting'] )
		{
			$valid = __('The value is too little!','acf-animate_parameters'),
		}
